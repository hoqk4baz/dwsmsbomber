...
class SendCall():
    ...
    def Porsche(self):
        try:
            ...
            if r.status_code == 302:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> Porsche")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> Porsche")
    ...
    def Pratik(self):
        try:
            ...
            if "Kaydınız alınmıştır." in r.text:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> Pratik")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> Pratik")
    ...
    def CinselTerapi(self):
        try:
            ...
            if r.json()["message"] == 'Mesajın için teşekkürler. Gönderildi.':
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> CinselTerapi")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> CinselTerapi")
    ...
    def Otelz(self):
        try:
            ...
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> Otelz")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> Otelz")
    ...
    def Express(self):
        try:
            ...
            if r.json()["message"] == 'Mesajınız için teşekkürler. Gönderildi.':
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> Express")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> Express")
    ...
    def Thepick(self):
        try:
            ...
            if r.json()["message"] == 'Thank you for your message. It has been sent.':
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> Thepick")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> Thepick")
    ...
    def Vajini(self):
        try:
            ...
            if r.status_code == 303:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> Vajini")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> Vaijini")
    ...
    def GmcYatirim(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data, allow_redirects=False)
            if (r.status_code) == 302:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı! ==> GmcYatirim")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız! ==> GmcYatirim")
